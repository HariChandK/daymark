...
const starter: Data = {
  tasks: [
    { id: "welcome-1", title: "Call Amma", dueDate: today, dueTime: "09:30", priority: "high", completed: false },
    { id: "welcome-2", title: "Finish the feature I've been avoiding", dueDate: today, dueTime: "12:30", priority: "medium", completed: false },
    { id: "welcome-3", title: "Sit outside for ten minutes", dueDate: today, dueTime: "20:00", priority: "low", completed: false },
  ],
  entries: [],
};
        ...
        {view === "timeline" ? (
          ...
          <div className="dashboard-grid">
            <div className="main-column">
              ...
              <section className="page-card closure-card"><div><span className="kicker">THE DAYMARK RITUAL</span><h2>Today doesn&apos;t need to feel complete.</h2><p>Just be honest about how it went. Some things can wait until tomorrow. Leaving them unfinished doesn&apos;t make today a failure.</p></div><div className="closure-stats"><strong>{complete}</strong><span>done</span><strong>{dayTasks.length - complete}</strong><span>to carry</span></div><button className="primary" onClick={closeDay}>Close today and carry things forward</button></section>
            </div>
